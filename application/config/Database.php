...
// $db['default']['hostname'] = 'driver=SQL Server;server=SIMAKDA\SQL2008SIMAKDA;uid=sa;pwd=SimakDa82&@b;database=db_simakda_2021';
// $db['default']['hostname'] = 'driver=SQL Server;server=MSM08;uid=;pwd=;database=simakda_2023;';
$db['default']['hostname'] = 'localhost';
$db['default']['username'] = 'sa';
$db['default']['password'] = 'msmkalbar';
$db['default']['database'] = 'simakda_2024_melawi';
